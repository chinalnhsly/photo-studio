...
git commit -m "feat: 影楼商城微信小程序修复了 Photographer 和 Booking 之间的实体关系;解决了 Product 和 Category 之间的关联;添加了 Tag 实体并与 Product 建立多对多关系;修复了 Order 和 Payment 之间的关联;解决了数据库连接和实体加载问题 [v1.2.3]" 
